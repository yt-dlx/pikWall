...
export default function RootLayout() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: Colorizer("#0D0907", 1.0) }}>
      <StatusBar backgroundColor="#0D0907" barStyle="light-content" />
      <LinearGradient
        colors={[Colorizer("#0D0907", 1.0), Colorizer("#0D0907", 0.8), Colorizer("#0D0907", 0.6), Colorizer("#0D0907", 0.4), Colorizer("#0D0907", 0.2), "transparent"]}
        style={{ position: "absolute", top: 0, left: 0, right: 0, height: 100, zIndex: 50 }}
      />
      <View style={{ flex: 1, backgroundColor: Colorizer("#0D0907", 1.0) }} className="capitalize">
