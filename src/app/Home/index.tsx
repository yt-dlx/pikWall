   ...
   >
    <TouchableOpacity onPress={() => onImagePress(image.previewLink, index)} className="p-[0.2px] flex-1">
     <View className="relative">
      ...
      <Text className="absolute m-1 bottom-1 right-1 px-2 text-xs rounded-2xl" style={{ fontFamily: "Linotte_Bold", color: Colorizer("#000000", 1.0), backgroundColor: Colorizer(image.primary, 1.0) }}>
    ...
    <TouchableOpacity>
     <View className="relative aspect-[9/16] w-full overflow-hidden">
      ...
      <View className="absolute bottom-0 left-0 right-0 items-center justify-start">
       <Animated.Text style={[textStyle, { textAlign: "center", fontFamily: "Linotte_Bold", color: Colorizer("#000000", 0.8), backgroundColor: Colorizer(data.images[currentIndex].primary, 1.0) }]} className="text-sm m-1 px-1 rounded-xl">
  ...
  <TouchableOpacity style={{ borderRadius: 4, overflow: "hidden", padding: 2 }} accessibilityLabel={`${category} category button`} accessibilityState={{ selected }} activeOpacity={0.7} onPress={onPress}>
   ...
   >
    <View style={{ flexDirection: "row", alignItems: "center" }}>
     ...
     <Text style={{ fontFamily: "Caveat_Bold", color: selected ? Colorizer("#E9E9EA", 1.0) : Colorizer("#000000", 1.0) }} className="ml-1 p-1 text-xl">
      {category}
     </Text>
    </View>
   </LinearGradient>
