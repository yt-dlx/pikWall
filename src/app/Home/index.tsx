...
const Card: React.FC<CardProps> = React.memo(({ data }) => {
  ...
  return (
    <View
      className="rounded-b-lg rounded-t-2xl overflow-hidden border"
      style={{
        backgroundColor: Colorizer("#171717", 1.0),
        borderColor: Colorizer(data.images[currentIndex].primary, 0.4)
      }}
    >
      <Link
        href={{
          ...
          style={[
            {
              width: 100,
              height: 1,
              backgroundColor: selected ? "#5f1314" : "#BABABB",
              borderRadius: 50
            },
            useAnimatedStyle(() => ({
          ...
          style={[
            {
              width: 100,
              height: 1,
              backgroundColor: selected ? "#BE2528" : "#E9E9EA",
              borderRadius: 50
            },
            useAnimatedStyle(() => ({
              transform: [{ translateX: translateX.value }]
