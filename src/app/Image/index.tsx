...
const SuccessModal: React.FC<{ visible: boolean; message: string; onClose: () => void }> = ({ visible, message, onClose }) => {
 ...
 return visible ? (
  <View className="absolute inset-0 justify-center items-center">
   ...
   <Animated.View className="rounded-lg items-center shadow-lg w-4/5 p-5" style={[{ backgroundColor: Colorizer("#E9E9EA", 1.0), shadowColor: Colorizer("#0A0A0A", 0.25), shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.25, shadowRadius: 10, elevation: 10 }, modalStyle]}>
...
const ErrorModal: React.FC<{ visible: boolean; message: string; onClose: () => void }> = ({ visible, message, onClose }) => {
 ...
 return visible ? (
  <View className="absolute inset-0 justify-center items-center">
   ...
   <Animated.View className="rounded-lg p-5 items-center shadow-lg w-4/5" style={[{ backgroundColor: Colorizer("#E9E9EA", 1.0), shadowColor: Colorizer("#0A0A0A", 0.25), shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.25, shadowRadius: 10, elevation: 10 }, modalStyle]}>
...
const DownloadingModal: React.FC<{ visible: boolean; percentage: number; downloadRate: number; eta: number; primaryColor: string }> = ({ visible, percentage, downloadRate, eta, primaryColor }) => {
 ...
 return visible ? (
  <View className="absolute inset-0 justify-center items-center">
   ...
   <View className="rounded-lg p-5 items-center shadow-lg" style={{ backgroundColor: Colorizer("#E9E9EA", 1.0), shadowColor: Colorizer("#0A0A0A", 0.25), shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.25, shadowRadius: 10, elevation: 10 }}>
