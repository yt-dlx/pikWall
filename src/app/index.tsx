      ...
      <Animated.View style={[animatedStyle]}>
        {images.concat(images).map((uri, idx) => (
          <Image
            ...
            style={{
              shadowColor: Colorizer("#0D0907", 1.0),
              height: imageHeight,
              borderRadius: 15,
              width: "100%",
              margin: 2
...
const AnimatedTitle: React.FC = () => {
  ...
  return (
    <Animated.View
      style={[animatedStyle, { shadowColor: Colorizer("#0D0907", 1.0), shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4, shadowRadius: 12 }]}
      className="items-center mb-4"
      entering={FadeIn.delay(300).duration(1500)}
    >
      <View className="rounded-full p-1" style={{ backgroundColor: Colorizer("#0D0907", 0.8), justifyContent: "center", alignItems: "center" }}>
        <Image
          alt="logo"
          contentFit="contain"
          cachePolicy="memory-disk"
...
const AppPage: React.FC = () => {
  ...
  return (
    <View style={{ backgroundColor: Colorizer("#0D0907", 1.0) }} className="h-full w-full">
      <View className="flex-1 justify-center items-center relative">
        <View className="flex-row h-full overflow-hidden relative">
          ...
          <LinearGradient
            colors={[Colorizer("#0D0907", 1.0), Colorizer("#0D0907", 0.4), Colorizer("#0D0907", 0.1), Colorizer("#0D0907", 0.4), Colorizer("#0D0907", 1.0)]}
            ...
            <Animated.View entering={FadeInDown.delay(600).duration(1500).springify()}>
              <View>
                <Text
                  ...
                  style={{
                    ...
                    textShadowColor: Colorizer("#0D0907", 1.0)
                  }}
                >
                  picWall
                </Text>
              ...
              <Link href="./Home" asChild>
                <TouchableOpacity onPressIn={onPressIn} onPressOut={onPressOut} className="mt-44 rounded-full overflow-hidden">
                  <Animated.View style={[buttonAnimatedStyle, { shadowColor: Colorizer("#0D0907", 1.0), shadowOffset: { width: 0, height: 4 } }]}>
                    <View style={{ backgroundColor: Colorizer("#F2EFE0", 1.0) }} className="flex-row items-center justify-center px-8 py-4">
                      <FontAwesome5 name="camera-retro" size={32} color={Colorizer("#0D0907", 1.0)} style={{ marginRight: 12 }} />
                      <Text className="text-2xl" style={{ fontFamily: "Lobster_Regular", color: Colorizer("#0D0907", 1.0) }}>
