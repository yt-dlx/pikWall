...
const Footer: React.FC = () => (
  <View style={{ backgroundColor: Colorizer("#000000", 1.0) }} className="relative w-full py-4">
    <View className="flex flex-col sm:flex-row items-center justify-between px-4">
      ...
      <Text style={{ fontFamily: "Caveat_Bold", color: Colorizer("#E9E9EA", 1.0) }} className="text-center text-xs mt-1">
