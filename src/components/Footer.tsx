...
const Footer: React.FC = () => (
  <View style={{ backgroundColor: Colorizer("#171717", 1.0) }} className="relative w-full p-2">
    <View style={{ backgroundColor: Colorizer("#171717", 0.6), borderRadius: 9999, paddingHorizontal: 12 }}>
