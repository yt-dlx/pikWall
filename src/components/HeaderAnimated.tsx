  ...
  return (
    <Animated.View style={animatedStyle} className="items-center m-4">
      <View style={{ backgroundColor: Colorizer("#070808", 0.6) }} className="rounded-full p-1">
        <Image source={require("@/assets/picWall/picWall_red.png")} alt="logo" className="w-24 h-24 rounded-full border-2" style={{ borderColor: Colorizer("#E9E9EA", 1.0) }} resizeMode="contain" />
      </View>
    </Animated.View>
  );
};
  ...
  return (
    <View className="flex-1 items-center justify-center mt-4">
      <View className="flex-row overflow-hidden rounded-xl relative" style={{ height: 220 }}>
        ...
        >
          <View style={{ backgroundColor: Colorizer("#070808", 0.5), borderRadius: 8 }} className="absolute inset-0" />
