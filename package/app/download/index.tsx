...
import { View, Image, Text, TouchableOpacity, ScrollView, Alert, ActivityIndicator, Dimensions, Animated, Easing } from "react-native";
//  =======================================================================================
//  =======================================================================================
...
const PreviewImage: React.FC<ImageProps> = ({ ImageData, screenWidth }) => {
  ...
  useEffect(() => {
    ...
    Animated.loop(
      ...
      { resetBeforeIteration: false } // Prevent resetting values before next loop
    ).start();

    // Rotating animation
    rotateValue.setValue(0); // Reset rotation explicitly to ensure smooth loop
    Animated.loop(
      Animated.timing(rotateValue, {
        toValue: 1,
        duration: 4000,
        useNativeDriver: true,
        easing: Easing.linear // Ensure continuous rotation
      }),
  ...
  return (
    <View className="relative">
      ...
      <View style={{ borderColor: ImageData.primary, borderWidth: 1, borderTopLeftRadius: 20, borderTopRightRadius: 20, overflow: "hidden" }} className="shadow-lg">
        {imageLoading && (
        ...
        <View className="relative">
          <Animated.Image
            style={!imageLoading ? { width: imageWidth, height: imageHeight, borderTopLeftRadius: 20, borderTopRightRadius: 20, transform: [{ scale: scaleValue }] } : { width: 0, height: 0 }}
        ...
        <View style={{ backgroundColor: ImageData.primary + "80" }} className="absolute bottom-0 left-0 right-0 backdrop-blur-sm p-1">
      ...
      <View style={{ padding: 10 }}>
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            backgroundColor: ImageData.primary
          }}
        >
