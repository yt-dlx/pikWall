...
const AnimatedTitle: React.FC = () => {
  ...
  return (
    <Animated.View style={animatedStyle} className="items-center">
      ...
      <Text style={{ fontFamily: "Kurale", fontSize: 28, fontWeight: "bold", color: Colorizer("#FFFFFF", 1.0), letterSpacing: -1, lineHeight: 34 }} className="tracking-tight">
        picBook™
      </Text>
    </Animated.View>
  );
  ...
  return (
    <View className="flex-1 items-center justify-center m-2">
      <View className="flex-row overflow-hidden rounded-xl relative" style={{ height: 240 }}>
        ...
        <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, justifyContent: "center", alignItems: "center", borderRadius: 8 }} className="absolute inset-0 items-center justify-center rounded-[8px] overflow-hidden">
          ...
          <View style={{ position: "absolute", justifyContent: "center", alignItems: "center", margin: 8, padding: 4 }} className="absolute justify-center items-center m-2 p-1">
            ...
            <View style={{ backgroundColor: Colorizer("#000000", 0.3), flexDirection: "row", alignItems: "center", marginTop: 8, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 9999 }} className="flex-row items-center mt-2 bg-black/30 px-2 py-1 rounded-full">
              <View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: Colorizer("#FFFFFF", 1.0), marginRight: 4, opacity: 0.5 }} className="w-1.5 h-1.5 rounded-full bg-white mr-1 animate-pulse" />
