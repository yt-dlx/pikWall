      ...
      <div className="relative z-10">
        <section className="py-20 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="container mx-auto px-4">
            <motion.h1 className="text-5xl md:text-7xl font-bold mb-6 text-3d bg-clip-text text-transparent bg-gradient-to-r from-gruvbox-red to-gruvbox-yellow" initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5, type: "spring", stiffness: 100 }}>
              Welcome to picBook 📚✨
            </motion.h1>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gruvbox-purple hover:bg-gruvbox-red text-gruvbox-bg0 font-bold py-3 px-6 rounded-full inline-flex items-center transition-colors duration-300 transform perspective-1000 hover-lift"
            ...
            <AnimatePresence mode="wait">
              {selectedBook ? (
                ...
                <motion.div key="bookshelf" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 50 }} transition={{ duration: 0.5 }}>
                  <motion.h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-3d text-gruvbox-yellow" initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5, type: "spring", stiffness: 100 }}>
