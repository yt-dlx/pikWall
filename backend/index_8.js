...
const directories = ["./sources/output/Anime/highRes", "./sources/output/Portrait/highRes", "./sources/output/Lightning/highRes", "./sources/output/Cinematic/highRes", "./sources/output/Photography/highRes"];
