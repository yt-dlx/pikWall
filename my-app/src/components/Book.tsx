    ...
    >
      <div className="book relative flex">
            ...
            {story.images.map((image, index) => (
              <motion.div key={index} className="relative aspect-square rounded-lg overflow-hidden shadow-lg hover-lift" whileHover={{ scale: 1.05 }}>
                ...
                <AnimatePresence>
                  {hoveredImage === index && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-gruvbox-bg0 bg-opacity-80 flex items-center justify-center p-4"
                    >
                ...
                <motion.a
                  ...
                  className="absolute bottom-2 right-2 bg-gruvbox-orange text-gruvbox-bg0 rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        ...
        <div className="w-1/2 p-8 relative">
          <motion.h2
            className="text-3xl font-bold mb-4 text-center text-gruvbox-yellow flex items-center justify-center"
        ...
        {/* Close button */}
        <motion.button
          className="absolute top-4 right-4 text-gruvbox-red hover:text-gruvbox-orange transition-colors duration-300"
          onClick={onClose}
