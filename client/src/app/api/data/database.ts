...
const database: Record<string, StoryEntry> = {
  ...
  "The Morning Serenity Meadow": {
    ...
    story_moral: "tranquility blossoms in the embrace of nature\u00e2\u20ac\u2122s morning light.",
    images: [
      {
