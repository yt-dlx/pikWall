...
export default function HomeScreen() {
  ...
  return (
    <View className="flex-1 bg-[#181b21] p-4 justify-center items-center">
      ...
      <Image source={{ uri: ImageData.uri }} className="h-96 w-96 rounded-lg shadow-lg" />
...
// <Text className="text-pink-400 font-bold text-lg">Go Back</Text>
// </TouchableOpacity>
// <Image source={{ uri: atob(ImageData.previewLink) }} alt={ImageData.original_file_name} className="h-96 w-96 rounded-lg shadow-lg" />
// <Text className="text-xl font-bold text-white mt-4">{ImageData.title}</Text>
// {/* Download Button */}
